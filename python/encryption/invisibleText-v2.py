...
# ================================================
# Invisible Text Tool - Raw XOR Cipher + Zero-width + Poem Key
# ================================================
...
tab = widgets.Tab()
tab.children = [
    widgets.VBox([cover_text, secret_text, btn_generate_cover, btn_hide, output_hide]),
    widgets.VBox([reveal_text, key_input, btn_reveal, output_reveal])
]
tab.set_title(0,"🔒 Hide")
tab.set_title(1,"🔓 Reveal")

display(HTML("<h2>🕵️ Invisible Text Tool - Raw XOR + Zero-width + Poem Key</h2>"))
display(tab)
